...
function App() {
  ...
  return (
    <>
      <div className=' w-full max-w-2xl mx-auto shadow-md px-5 py-3 my-10 bg-teal-950 text-black rounded-lg'  >
        <h1 className='text-white text-center my-3 font-thin text-2xl  '>Password Generator</h1>
